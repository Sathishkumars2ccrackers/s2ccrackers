...
const DEFAULT_SLIDES = [
  {
    ...
    linkUrl: '/all-crackers',
    secondaryButtonText: 'Explore Gift Boxes',
    secondaryLinkUrl: '/products?category=deluxe-gift-boxes',
  ...
  },
  {
    ...
    buttonText: 'Order Now',
    linkUrl: '/products?category=deluxe-gift-boxes',
    secondaryButtonText: 'View All Deals',
    secondaryLinkUrl: '/all-crackers',
  ...
  },
  {
    ...
    buttonText: 'Order Now',
    linkUrl: '/all-crackers',
    secondaryButtonText: 'Family Combos',
    secondaryLinkUrl: '/products?category=deluxe-gift-boxes',
